...
CREATE TABLE `Reviews` (
    ...
    UNIQUE INDEX `Reviews_content_key`(`content`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Reviews` ADD CONSTRAINT `Reviews_servicesId_fkey` FOREIGN KEY (`servicesId`) REFERENCES `services`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
