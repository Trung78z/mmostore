...
-- AddForeignKey
ALTER TABLE `orders` ADD CONSTRAINT `orders_productAccountId_fkey` FOREIGN KEY (`productAccountId`) REFERENCES `productAccount`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `productAccount` ADD CONSTRAINT `productAccount_sellId_fkey` FOREIGN KEY (`sellId`) REFERENCES `services`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
