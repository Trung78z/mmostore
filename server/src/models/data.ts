  ...
  return [
    {
      ...
      updatedAt: "2024-07-04T12:40:45.385Z",
      postCategoryId: 1,
      userId: userId,
    },
    {
...
export function serviceCategories() {
  return [
    {
      category: "product" as RoleService,
      data: [
        {
          subCategory: "Tài khoản",
          subCategoryCover: createSlug("Tài khoản"),
          childrenCategory: [
            { childrenCategory: "Tài khoản FB" },
            { childrenCategory: "Tài Khoản BM" },
            { childrenCategory: "Tài Khoản Zalo" },
            { childrenCategory: "Tài Khoản Twitter" },
            { childrenCategory: "Tài Khoản Telegram" },
            { childrenCategory: "Tài Khoản Instagram" },
            { childrenCategory: "Tài Khoản Shopee" },
            { childrenCategory: "Tài Khoản Discord" },
            { childrenCategory: "Tài khoản TikTok" },
            { childrenCategory: "Key Diệt Virus" },
            { childrenCategory: "Key Window" },
            { childrenCategory: "Tài Khoản Khác" },
          ],
        },
        {
          subCategory: "Email",
          subCategoryCover: createSlug("Email"),
          childrenCategory: [
            { childrenCategory: "Gmail" },
            { childrenCategory: "HotMail" },
            { childrenCategory: "OutlookMail" },
            { childrenCategory: "RuMail" },
            { childrenCategory: "DomainMail" },
            { childrenCategory: "YahooMail" },
            { childrenCategory: "ProtonMail" },
            { childrenCategory: "Loại Mail Khác" },
          ],
        },
        {
          subCategory: "Phần mềm",
          subCategoryCover: createSlug("Phần mềm"),
          childrenCategory: [
            { childrenCategory: "Phần Mềm FB" },
            { childrenCategory: "Phần Mềm Google" },
            { childrenCategory: "Phần Mềm Youtube" },
            { childrenCategory: "Phần Mềm Tiền Ảo" },
            { childrenCategory: "Phần Mềm PTC" },
            { childrenCategory: "Phần Mềm Capcha" },
            { childrenCategory: "Phần Mềm Offer" },
            { childrenCategory: "Phần Mềm PTU" },
            { childrenCategory: "Phần Mềm Khác" },
          ],
        },
        {
          subCategory: "Khác",
          subCategoryCover: createSlug("Khác"),
          childrenCategory: [
            { childrenCategory: "Thẻ nạp" },
            { childrenCategory: "VPS" },
            { childrenCategory: "Khác" },
          ],
        },
      ],
    },
    {
      category: "service" as RoleService,
      data: [
        {
          subCategory: "Tăng tương tác",
          subCategoryCover: createSlug("Tăng tương tác"),
          childrenCategory: [
            { childrenCategory: "Dịch vụ Facebook" },
            { childrenCategory: "Dịch vụ Tiktok" },
            { childrenCategory: "Dịch vụ Google" },
            { childrenCategory: "Dịch vụ Telegram" },
            { childrenCategory: "Dịch vụ Shopee" },
            { childrenCategory: "Dịch vụ Discord" },
            { childrenCategory: "Dịch vụ Twitter" },
            { childrenCategory: "Dịch vụ Youtube" },
            { childrenCategory: "Dịch vụ Zalo" },
            { childrenCategory: "Dịch vụ Instagram" },
            { childrenCategory: "Tương tác khác" },
          ],
        },
        {
          subCategory: "Dịch vụ phần mềm",
          subCategoryCover: createSlug("Dịch vụ phần mềm"),
          childrenCategory: [
            { childrenCategory: "Dịch vụ code tool" },
            { childrenCategory: "Dịch vụ đồ họa" },
            { childrenCategory: "Dịch vụ video" },
            { childrenCategory: "Dịch vụ tool khác" },
          ],
        },
        {
          subCategory: "BlockChain",
          subCategoryCover: createSlug("BlockChain"),
          childrenCategory: [
            { childrenCategory: "Dịch vụ tiền ảo" },
            { childrenCategory: "Dịch vụ NFT" },
            { childrenCategory: "Dịch vụ Coinlist" },
            { childrenCategory: "Blockchain khác" },
          ],
        },
        {
          subCategory: "Dịch vụ khác",
          subCategoryCover: createSlug("Dịch vụ khác"),
          childrenCategory: [{ childrenCategory: "Dịch vụ khác" }],
        },
      ],
    },
  ];
