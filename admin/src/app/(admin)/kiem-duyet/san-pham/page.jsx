...
export default function DonHangSanPham() {
  ...
  const fetch = async () => {
    try {
      const response = await axios.get("/products/admin/products", {
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-center">Sản phẩm trùng</TableHead>
                <TableHead className="text-center">Quảng cáo</TableHead>
            ...
            <TableBody>
              {data.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell className="text-center">
                    {item?.duplicate === false ? "Không trùng" : "Trùng"}
                  </TableCell>
                  <TableCell className="text-center">
                    {item?.sponsor === false ? "Không" : "Có"}
                  </TableCell>
                  <TableCell className="text-center">
