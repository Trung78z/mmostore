                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  <div className="col-span-2 px-2 md:px-20">
                    ...
                    <ul>
                      <li className="ml-0">
                        STK:
                        <span className="font-semibold">88899999365</span>
                      </li>
                      <li className="ml-0">
                        Người nhận:
                        <span className="font-semibold">Võ Ngọc Minh </span>
                      </li>
                  ...
                  <div className="col-span-2 px-2 text-red-500 md:px-20">
                    ...
                    <div className="relative mx-auto max-h-72 min-h-72 max-w-60 text-center">
                      <Image
                        src="/35f0f161ee734b2d1262.jpg"
                        alt=""
