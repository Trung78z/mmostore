    ...
    <div className="card p-2 md:p-10">
      ...
      <Fieldset className="mt-10 space-y-8">
        ...
        <ul className="ml-2 sm:ml-10">
          ...
          <li className="text-green-500">
            <p>
              Không đăng các bài viết quảng cáo, tuyển ref, giới thiệu dự án,
              lùa gà... (không cần biết dự án có lừa đảo hay không)
            </p>
          </li>
          <li className="text-green-500">
            <p>
              Không đăng nội dung vi phạm quyền sở hữu trí tuệ của người khác,
              bao gồm vi phạm nhãn hiệu hàng hóa và bản quyền.
            </p>
          </li>
          <li className="text-green-500">
            <p>
              Những bài viết chất lượng sẽ được lựa chọn để làm điểm tuần và
              nhận thưởng từ sàn.
            </p>
          </li>
          <li className="text-green-500">
