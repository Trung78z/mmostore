    ...
    <>
      ...
      >
        <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
          <DialogPanel className="min-w-min max-w-lg space-y-4 rounded-lg border bg-gray-200 p-6">
            <Input
              type="text"
              name="title"
              id="title"
            ...
            {row.map((item) => {
              return (
                ...
                >
                  <Link
                    href={`/danh-muc/${item.serviceCategory === "product" ? "san-pham" : "dich-vu"}/${item.serviceSubCategory.subCategoryCover}/${item.slug}`}
